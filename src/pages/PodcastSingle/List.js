...
const EditPodcast = ({ episode_id, setEditPodcastModal, editEpisodeModal }) => {
  ...
  const imageHandler = e => {
    ...
    if (!difference_identifier.cover_pic)
      set_difference_identifier({ ...difference_identifier, cover_pic: true })
  }
...
const List = props => {
  ...
  return (
    <React.Fragment>
      <Row>
        {edit_podcast_id != null ? (
          <EditPodcast
            editEpisodeModal={editEpisodeModal}
            episode_id={edit_podcast_id}
            setEditPodcastModal={setEditPodcastModal}
          />
        ) : null}
        {confirm_delete ? (
          <SweetAlert
