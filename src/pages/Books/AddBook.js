...
const AddBook = props => {
   ...
   const [is_selected_admin, set_is_selected_admin] = useState("")
   ...
   const [featurePicture, setFeaturePicture] = useState(null)
   ...
   const createBook = async () => {
      ...
      data["has_sale"] = sale_price != 0 ? true : false
      ...
      if (book_picture != null) formData.append("files.picture", book_picture, book_picture.name)
      if (featurePicture != null) formData.append("files.featured_picture", featurePicture, featurePicture.name)
   ...
   const handleFeaturePicture = f => {
      ...
      setFeaturePicture(f.target.files[0])
   }
                                    ...
                                    <Row>
                                       <Col lg={7}>
                                          <FormGroup className="select2-container mx-auto">
                                             ...
                                             >
                                                ...
                                                {props.admins_info.length != 0 ? props.admins_info.map(admin => <option value={admin.id}>{admin.username}</option>) : null}
                                             </select>
                                             <p className="text-danger font-size-10">{is_selected_admin}</p>
                                          </FormGroup>
                                       </Col>
                                       <Col lg="5">
                                          <FormGroup>
                                             ...
                                             />
                                             <p class="text-danger font-size-10">{book_name_message}</p>
                                          </FormGroup>
                                       </Col>
                                       <Col lg={7}>
                                          ...
                                          <Row>
                                             ...
                                             <Col lg="6">
                                                <FormGroup>
                                                   <img className="rounded" src={featureUrl} alt={book_name_value} id="img" className="img-fluid" style={{ height: "150px", width: "400px" }} />
                                       ...
                                       <Col lg={5}>
                                          <FormGroup>
                                             ...
                                             <img className="rounded" src={profileImage} alt={book_name_value} id="img" className="img-fluid" style={{ height: "30vh", width: "90%" }} />
                                          ...
                                          <>
                                             ...
                                             <Col lg={3}>
                                                <Input
                                                   type="number"
                                                   // value="0"
                                                   onChange={e => set_sale_price(e.target.value)}
                                                />
                                             </Col>
                                          </>
                                       ) : null}
                           ...
                           <ul className="pager wizard twitter-bs-wizard-pager-link">
                              ...
                              <li className={activeTab === 4 ? "next disabled" : "next"}>
                                 <Link
                                    ...
                                    onClick={e => {
                                       handle1(e)
                                       if (activeTab === 1 && book_name_value !== "" && selectedMulti_category != null && selectedMulti_author != null && admin_id != null) {
                                          toggleTab(activeTab + 1)
                                       }
