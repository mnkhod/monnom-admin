...
const CardContact = props => {
   ...
   const [user_delete_modal_center, set_user_delete_modal_center] = useState(false)
   ...
   const sendEditUserRequest = user_id => {
      ...
      if (edit_username == "" && edit_password == "" && edit_phone == "" && edit_email == "") {
      ...
      <React.Fragment>
         ...
         >
            ...
            <div className="modal-body">
               <Row>
                  <Col xs={5}>{user.img ? <img alt={user.name + " name"} src={user.img} height="200" width="100%" /> : null}</Col>
                  <Col xs={7}>
